...
public class Hashmapremoved extends Basetest{
	...
	//Starting with section 21	    
		    ...
		    List<HashMap<String,String>> data = getjsontomap(System.getProperty("user.dir")+"src//test//java//Rahulsheteacademy_Selenium_Framework_Section21//data//Purchase.json");
